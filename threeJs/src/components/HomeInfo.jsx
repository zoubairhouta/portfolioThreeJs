...
<Link to={link} className ="nep-brutalism-white neo-btn">
...
const renderContent = {
    ...
    1: (
        <h1 className="sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5">
           Hi , I am <span className='font-semibold'> Zoubair</span>👋🏼👋🏼
           <br/>
    ...
    4: (
        <InfoBox text="Need a project done or looking for a dev ? I'm just a few keystrockes away"
